    ...
    func mapToWeathersObject() -> [Weather] {
        ...
        determineTimeZoneIdentifier(for: self.city.name) { timeZone in
            ...
            for forecast in self.forecasts {
                ...
                weather.city.sunrise = String(self.city.sunrise.convertUnixToReadableTime(for: self.city.name, timeZoneIdentifier: timeZone))
                weather.city.sunset = String(self.city.sunset.convertUnixToReadableTime(for: self.city.name, timeZoneIdentifier: timeZone))
